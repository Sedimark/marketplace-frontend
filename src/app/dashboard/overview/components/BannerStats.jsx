  ...
  return (
    <div className='m-10'>
      <div className='flex flex-row gap-5'>
        <div className='flex flex-col items-center gap-3 bg-white rounded-lg shadow-lg w-36 h-36 text-center p-2'>

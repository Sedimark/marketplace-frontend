...
function Asset ({ asset }) {
  ...
  return (
    <div className='flex flex-col bg-sedimark-light-blue'>
      ...
      <Card className='bg-sedimark-light-blue w-full border-none shadow-none' imgSrc={imageUrl} horizontal>
      ...
      <Card className='bg-sedimark-light-blue w-full border-none shadow-none' horizontal>
        <h5 className='text-xl tracking-tight text-gray-900 dark:text-white'>
        ...
        <div className='flex flex-wrap gap-2'>
          {keywords.map((keyword, index) => {
            return (
              <Badge key={`${keyword}-${index}`} className='text-sedimark-deep-blue bg-sedimark-clear-blue'>{keyword}</Badge>
            )
          })}
        </div>
      </Card>
